...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.g1uks.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
console.log(uri);
...
app.get("/", (req, res) => {
  res.send("order form is running");
});
